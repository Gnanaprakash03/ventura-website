             ...
             <div className="relative flex items-center justify-center w-full h-[500px]">
              ...
              <div className="absolute flex items-center justify-center w-32 h-32 border border-teal-400/40 rounded-full shadow-lg group relative">
                ...
                <span className="absolute bottom-[-2.5rem] left-1/2 -translate-x-1/2 
                   bg-gradient-to-r from-teal-400 to-blue-500 text-white text-xs font-medium 
              ...
              {/* Rotating Orbit */}
              <motion.div
                className="absolute w-[400px] h-[400px] rounded-full border border-teal-400/40 "
                animate={{ rotate: 360 }}
              ...
              >
                {nodes.map((node, i) => {
                  ...
                  return (
                    <motion.div
                      key={i}
                      className="absolute flex flex-col items-center justify-center w-24 h-24 bg-gradient-to-r from-teal-400 to-blue-500 rounded-full shadow-md rounded-full shadow-md backdrop-blur-sm group"
                      style={{
