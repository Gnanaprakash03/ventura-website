...
import SoftwareIntegrations from './softwarecontent';
  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-50 to-blue-50 text-gray-800">
      <div className=" pt-0">
        ...
        <section className="px-4 sm:px-8 md:px-12 py-8 w-full max-w-6xl mx-auto">
              <ScrollAnimationWrapper>
                <h2
                  className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-center 
                            pb-2 sm:pb-3 mb-6 sm:mb-8 md:mb-10 
              ...
              <div className="relative w-full overflow-hidden">
                <div className="flex">
                  <div
                    className="flex space-x-6 sm:space-x-8 md:space-x-12 whitespace-nowrap animate-marquee"
                  ...
                  >
                    ...
                    {pageData?.trustedCompanies.map((company, index) => (
                      <div
                        key={`first-${index}`}
                        className="flex-shrink-0 flex items-center justify-center min-w-[120px] sm:min-w-[160px] md:min-w-[200px]"
                      >
                        <Image
                ...
                <Celebration>
                  ...
                  >
                    <div className="flex items-center gap-4 sm:gap-6 relative z-10">
                      <motion.div className="text-3xl sm:text-4xl md:text-5xl font-bold inline-flex items-center bg-gradient-to-r from-yellow-400 to-yellow-200 bg-clip-text text-transparent px-2">
        ...
        <section id="Features"  className="relative  w-full  mx-auto px-10  shadow:lg  ">
          ...
          <div className=' my-5  z-50 rounded-2xl px-4'>
           <h2 className="text-xl sm:text-4xl md:text-5xl lg:text-5xl text-center mb-1 bg-clip-text text-slate-900 bg-gradient-to-r from-blue-600 to-teal-400 flex flex-wrap justify-center items-center gap-2 relative">
        ...
        <section className=" py-16 bg-gray-50">
          ...
          <SoftwareIntegrations nodes={nodes} />
        ...
        <section className="py-4 w-full max-w-7xl mx-auto relative px-2">
            <h2 className="sticky top-[4.5rem] z-20 py-3 mb-6 text-3xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-teal-400 bg-white/70 backdrop-blur-md">
